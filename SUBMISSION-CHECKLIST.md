...
|---|---|---|---|
| `terraform validate` | [`terraform/`](terraform/), [`native-monitoring/`](native-monitoring/), [`immutable-vault/`](immutable-vault/) | [Capstone green run](https://github.com/jtflack-grc/grc-engineering-pipeline/actions/runs/29831090514) | Complete for the original capstone; hardened directories are checked by the current PR gate |
...
| Cosign verification | [`scripts/verify-evidence.sh`](scripts/verify-evidence.sh) | [`sc28-traversal.txt`](evidence/oscal-validation/sc28-traversal.txt) | Complete |
